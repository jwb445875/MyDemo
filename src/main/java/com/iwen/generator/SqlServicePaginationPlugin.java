...
public class SqlServicePaginationPlugin extends PluginAdapter {
...
//		addField("pageSize", intType, topLevelClass);
		...
		addField("limitStart", intType, topLevelClass);
		addField("limitEnd", intType, topLevelClass);
...
//		getSkipCountMethod
//				.addBodyLine("return this.limitStart;");
//
...
//				.addBodyLine("return this.limitEnd-this.limitStart;");
//
...
//		newConstructorMethod.addParameter(new Parameter(intType, "limitStart"));
//		newConstructorMethod.addParameter(new Parameter(intType, "limitEnd"));
//		newConstructorMethod.addBodyLine("this();");
//		newConstructorMethod.addBodyLine("this.limitStart=limitStart;");
//		newConstructorMethod.addBodyLine("this.limitEnd=limitEnd;");
...
//		topLevelClass.addMethod(newConstructorMethod);
	...
	public boolean sqlMapDocumentGenerated(Document document,
		...
		sb.append(" not in (select top ${limitStart} " );
		if (pks.size()==1){
			sb.append(MyBatis3FormattingUtilities.getAliasedEscapedColumnName(pks.get(0)));
		}else{
			sb.append(" #your_primary_key_name ");
