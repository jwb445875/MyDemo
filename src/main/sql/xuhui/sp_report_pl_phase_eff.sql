...
(id,type,area_id,area_name,company_id,project_id,fenqi_id,batch_id,node_code,node_name,planned_finish_date,actual_finish_date)
select uuid(),a.type,a.area, a.area_name,a.company_id,a.project_id,a.fenqi_id,a.batch_id,d.node_code,d.node_name,d.planned_finish_date ,d.actual_finish_date
