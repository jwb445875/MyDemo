...
INSERT pl_report_plan_node_feed(id,type,plan_type_id,biz_type,business_type,area_id,area_name,company_id,project_id,fenqi_id,plan_name,batch_id,
node_name,level_id,planned_finish_date,risk_type,risk_comment,feedback_date,node_biz_type)
SELECT DISTINCT
    UUID_SHORT(),p.type,p.plan_type_id,p.biz_type,p.business_type,p.area,p.area_name,p.company_id,p.project_id,p.fenqi_id,
		...
		fb.risk_type,fb.risk_comment,fb.created_date ,n.biz_type
	FROM
	pl_feedback_info fb
